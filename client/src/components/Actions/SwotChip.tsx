...
const SwotChip = observer(({ entry, actionId, onDelete, onMouseEnter, onMouseLeave }: SwotChipProps) => {
  ...
  return (
    <Chip
      ...
      sx={{ 
        ...
        color: theme.palette.getContrastText(getSwotColor(entry.type, theme).main),
